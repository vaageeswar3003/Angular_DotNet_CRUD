...
namespace InspectionAPI.Controllers
{
    ...
    public class InspectionsController : ControllerBase
    {
        ...
        // GET: api/Inspections
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Inspection>>> GetInspectionss()
        {
            return await _context.Inspectionss.ToListAsync();
        }
        ...
        {
            var inspection = await _context.Inspectionss.FindAsync(id);
        ...
        {
            _context.Inspectionss.Add(inspection);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteInspection(int id)
        {
            ...
            _context.Inspectionss.Remove(inspection);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Inspectionss.Any(e => e.Id == id);
        }
    }
}
